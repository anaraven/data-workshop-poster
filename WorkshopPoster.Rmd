...
```{r xkcd, warning=FALSE, message=FALSE}
library(extrafont)
library(ggplot2)
library(xkcd)
...
ggplot() + geom_text(aes(Release,WGS.Bases,label="0"), gb, family="Humor Sans",alpha=0.8) +
  axes + twomen + 
  xkcdline(aes(xbegin=145, ybegin=6e11, xend=160, yend=72e10), NULL, xjitteramount = 12) +
  annotate("text",x=160, y=75e10, label="Genbank data keeps growing!", family="Humor Sans")
```
